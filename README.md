...
| Titulo | Descrição                                                                      |
| ------ | ------------------------------------------------------------------------------ |
| Long Method   | Uso e repetição de muitas estruturas condicionais (ifs e switchs) desnecessariamente tanto no menu principal quanto no menu de alteração do empregado. |
